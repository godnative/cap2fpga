...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(620, 430, 111, 80))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.bt_record = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.bt_record.setObjectName("bt_record")
        self.verticalLayout_3.addWidget(self.bt_record)
        self.bt_savecoe = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.bt_savecoe.setObjectName("bt_savecoe")
        self.verticalLayout_3.addWidget(self.bt_savecoe)
    ...
    def retranslateUi(self, Form):
        ...
        self.cb_selectbaud.setCurrentText(_translate("Form", "921600"))
        self.cb_selectbaud.setItemText(0, _translate("Form", "921600"))
        self.cb_selectbaud.setItemText(1, _translate("Form", "115200"))
        self.cb_selectbaud.setItemText(2, _translate("Form", "9600"))
        self.cb_selectbaud.setItemText(3, _translate("Form", "38400"))
        self.cb_selectbaud.setItemText(4, _translate("Form", "460800"))
        ...
        self.bt_record.setText(_translate("Form", "录制文件"))
        self.bt_savecoe.setText(_translate("Form", "保存文件"))
